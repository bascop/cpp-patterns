...
void TestObserver::onNotification(const cpp_patterns::Notification &notification)
{
    ...
    if (onNotificationWithEventFn != nullptr)
    {
        onNotificationWithEventFn(notification);
    }
}
